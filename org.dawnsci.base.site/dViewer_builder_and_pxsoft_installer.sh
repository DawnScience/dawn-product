...
while true; do
  ...
  echo "ssh ${PXSOFT_WRITER_HOST} \"cp -pf ${BUILDER_PATH}/${PRODUCT_PXSOFT_INSTALLER} ${PRODUCT_TARGET_INSTALLER_FOLDER_PATH}; ${PRODUCT_TARGET_INSTALLER_FILE_PATH} ${BUILDER_PATH} ${PRODUCT_ID} ${VERSION}\""
