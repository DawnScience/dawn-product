...
public class Messages extends NLS {
    private static final String INTRO_RESOURCE_BUNDLE = "org.dawnsci.internal.intro.universal.Messages"; //$NON-NLS-1$
	...
	public static String SharedIntroConfigurer_perspectives_name;
	public static String SharedIntroConfigurer_perspectives_alt;
	public static String SharedIntroConfigurer_perspectives_tooltip;
	...
	public static String SharedIntroConfigurer_perspectives_nav;
	...
	public static String WelcomeCustomizationPreferencePage_perspectives;
	...
	public static String WelcomeCustomizationPreferencePage_NoMnemonic_perspectives;
