...
public interface IUniversalIntroConstants {
    ...
    // General consts.
    // ---------------
    String PLUGIN_ID = "org.dawnsci.intro.universal"; //$NON-NLS-1$
	...
	String ID_PERSPECTIVES = "perspectives";//$NON-NLS-1$
	...
	String LAUNCHBAR_PERSPECTIVES_ICON = "launchbarPerspectivesIcon"; //$NON-NLS-1$
